...
I am a postdoctoral research fellow at the Massachusetts General Hospital ([Cardiovascular Research Center](http://cvrc.massgeneral.org), [Clinical Data Animation Center](http://cdac.mgh.harvard.edu), and [Healthcare Transformation Lab](http://healthcaretransformation.org)) and Massachusetts Institute of Technology ([Computational Cardiovascular Research Group](http://www.rle.mit.edu/cb/)). My advisors are [Aaron Aguirre](https://connects.catalyst.harvard.edu/Profiles/display/Person/10465), [Brandon Westover](https://connects.catalyst.harvard.edu/Profiles/display/Person/84202), and [Collin Stultz](http://imes.mit.edu/people/faculty/stultz-collin/). We build machine learning algorithms to read ECGs, predict cardiovascular emergencies from physiological time series data, and phenotype shock.
